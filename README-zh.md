...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 MediaWiki 复杂的安装及配置。
...
如果需要企业级支持，请订阅我们提供的 [MediaWiki 企业级支持版](https://apps.websoft9.com/mediawiki) 
