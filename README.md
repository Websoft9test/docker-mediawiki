...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r mediawiki
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r mediawiki -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-mediawiki
cd docker-mediawiki
docker-compose  up -d
```
...
| --- | --- | --- | --- |
| MediaWiki | 9001 | Browser access to MediaWiki Document by http | Y |
## Documentation

[MediaWiki Administrator Guide](https://support.websoft9.com/docs/mediawiki)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [MediaWiki Enterprise Support](https://apps.websoft9.com/mediawiki) 
